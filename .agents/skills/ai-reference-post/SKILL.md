...
description: >-
  ...
  editing _config.yml or layouts alone, writing AGENTS.md, or general non-blog coding tasks.
---
...
- slug는 영문 소문자·하이픈으로 짓는다 (예: `Codex-essentials-20`).
...
- `categories`: **단수 id 하나만**. 사용 가능한 값과 의미:
  ...
  | `skills-mcp` | 스킬 & MCP | Codex 스킬, MCP 서버, 플러그인 |
  | `cloud-llm` | 클라우드 LLM | Codex/GPT/Gemini 등 동향 |
...
- 글 끝에 **관련 글** 섹션을 둔다. 형식:
  ...
  ```markdown
  **관련 글**
  - {% post_url 2026-05-07-ai-cli-tools-installation %} — Codex 설치 방법
...
- 커밋 메시지 끝에 `Co-Authored-By: Codex Opus 4.8 <noreply@anthropic.com>` 를 붙인다.
